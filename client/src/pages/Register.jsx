        ...
        <div className="relative z-20 flex flex-col justify-center px-12 text-white">
          ...
          >
            ...
            <p className="text-lg text-gray-300">
              Create your account and start experiencing the future of voice interaction. 
              Get access to advanced AI features and join our growing community.
            </p>
            <div className="space-y-4">
              ...
              >
                ...
                <span className="text-gray-200">Voice-first interaction</span>
              </motion.div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="flex items-center space-x-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors duration-200"
              >
                ...
                <span className="text-gray-200">Advanced AI capabilities</span>
              </motion.div>
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="flex items-center space-x-3 p-3 rounded-lg bg-white/5 hover:bg-white/10 transition-colors duration-200"
              >
                ...
                <span className="text-gray-200">Premium audio experience</span>
              </motion.div>
            </div>
          </motion.div>
        </div>
